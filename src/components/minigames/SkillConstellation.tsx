  ...
  if (isCompleted || showSuccess) {
    return (
      ...
      >
        ...
        <h2 className="text-neon font-game text-sm mb-3">CONSTELLATION ALIGNED</h2>
        <p className="text-gray-400 font-mono text-xs">All skill connections established.</p>
        <p className="text-neon font-mono text-xs mt-4">Key Fragment #2 acquired</p>
      </motion.div>
    );
  }
